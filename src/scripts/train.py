...
def main():
    ...
    config['computing_environment'] = {'num_nodes':cli_args.num_nodes,'num_devices':cli_args.num_devices}
    ...
    # print(500*"=","Shape of data","="*500)
    # print(len(datamodule.train_dataloader().dataset))
    # print(1500*"=")
    #shape of the data
    # print(50*"=","Shape of data","="*50)
    # #datamodel is a <class 'utils.lightning.GenericDataModule.GenericDataModule'>
    # #shape of the data sample
